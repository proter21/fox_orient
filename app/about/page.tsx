          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              ...
              <p className="text-lg mb-4">
                ...
                професионалисти в областта на радиолюбителството и
                радиозасичането – &quot;лов на лисици&quot; - ARDF - (amateur
                radio derection finding). Нашата мисия е да популяризираме и
                развиваме тези вълнуващи спортове в България, организирайки
                състезания, тренировки и събития за всички възрасти и нива на
                опит.
              </p>
              <p className="text-lg">
